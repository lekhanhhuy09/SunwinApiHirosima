...
const API_KEY = "bolekhanhhuyvidai"; // Thay đổi key này bằng key của bạn
...
fastify.addHook("onRequest", async (request, reply) => {
  if (request.url.startsWith("/api/sunwin") || request.url.startsWith("/api/history-json")) {
    ...
    if (!urlKey || urlKey !== API_KEY) {
      return reply.code(403).send({ error: "Key sai mẹ rồi, liên hệ tele: @hirosimatrickerfb" });
    }
  }
});

// For WebSocket authentication
const authenticateSocket = (id, key) => {
...
function connectWebSocket() {
  ws = new WebSocket("wss://websocket.azhkthg1.net/wsbinary?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Gbzs8xl82xzuRlmwx-mic-yUSq2AFEBNji9nhAacSbA");
